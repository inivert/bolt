    ...
    <div class="max-w-md w-full">
      ...
      <div class="bg-white rounded-2xl shadow-xl p-8 space-y-6 animate-slide-up">
        ...
        <div class="flex items-center justify-between mt-6 text-sm">
          <NuxtLink to="/forgot-password" class="font-medium text-primary-600 hover:text-primary-500 transition-colors duration-200">
            Forgot your password?
          </NuxtLink>
          <NuxtLink to="/register" class="font-medium text-primary-600 hover:text-primary-500 transition-colors duration-200">
            Create account
          </NuxtLink>
        </div>
      </div>
